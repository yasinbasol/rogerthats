...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="resources/plugins/maps-amcharts/ammap/ammap.min.css" rel="stylesheet">
    <!-- END PAGE STYLE -->
    <script src="resources/plugins/modernizr/modernizr-2.6.2-respond-1.1.0.min.js"></script>
  </head>
  ...
  <body class="fixed-topbar fixed-sidebar theme-sdtl color-default">
          ...
          <div class="header-right">
            <ul class="header-menu nav navbar-nav">
              ...
              <li class="dropdown" id="language-header">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="#" data-lang="en"><img src="resources/images/flags/usa.png" alt="flag-english"> <span>English</span></a>
                  </li>
                  <li>
                    <a href="#" data-lang="es"><img src="resources/images/flags/spanish.png" alt="flag-english"> <span>Español</span></a>
                  </li>
                  <li>
                    <a href="#" data-lang="fr"><img src="resources/images/flags/french.png" alt="flag-english"> <span>Français</span></a>
                  </li>
                </ul>
              </li>
              <!-- END USER DROPDOWN -->
                  ...
                  <li class="dropdown-body">
                    <ul class="dropdown-menu-list withScroll" data-height="220">
                      <li class="clearfix">
                        ...
                        <img src="resources/images/avatars/avatar3.png" alt="avatar 3">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="resources/images/avatars/avatar4.png" alt="avatar 4">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="resources/images/avatars/avatar5.png" alt="avatar 5">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="resources/images/avatars/avatar6.png" alt="avatar 6">
                        </span>
                        <div class="clearfix">
                          <div>
              ...
              <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                <img src="resources/images/avatars/user1.png" alt="user image">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 portlets">
              ...
              <div class="panel widget-member clearfix">
                <div class="col-xs-3">
                  <img src="resources/images/avatars/user2.png" alt="avatar 12" class="pull-left img-responsive">
                </div>
                <div class="col-xs-9">
      ...
      <div class="morphsearch-content withScroll">
        <div class="dummy-column user-column">
          ...
          <a class="dummy-media-object" href="#">
            <img src="resources/images/avatars/avatar1_big.png" alt="Avatar 1"/>
            <h3>John Smith</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/avatars/avatar2_big.png" alt="Avatar 2"/>
            <h3>Bod Dylan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/avatars/avatar3_big.png" alt="Avatar 3"/>
            <h3>Jenny Finlan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/avatars/avatar4_big.png" alt="Avatar 4"/>
            <h3>Harold Fox</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/avatars/avatar5_big.png" alt="Avatar 5"/>
            <h3>Martin Hendrix</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/avatars/avatar6_big.png" alt="Avatar 6"/>
            <h3>Paul Ferguson</h3>
          </a>
        </div>
        <div class="dummy-column">
          <h2>Articles</h2>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/1.jpg" alt="1"/>
            <h3>How to change webdesign?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/2.jpg" alt="2"/>
            <h3>News From the sky</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/3.jpg" alt="3"/>
            <h3>Where is the cat?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/4.jpg" alt="4"/>
            <h3>Just another funny story</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/5.jpg" alt="5"/>
            <h3>How many water we drink every day?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/6.jpg" alt="6"/>
        ...
        <div class="dummy-column">
          <h2>Recent</h2>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/7.jpg" alt="7"/>
            <h3>Design Inspiration</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/8.jpg" alt="8"/>
            <h3>Animals drawing</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/9.jpg" alt="9"/>
            <h3>Cup of tea please</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/10.jpg" alt="10"/>
            <h3>New application arrive</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/11.jpg" alt="11"/>
            <h3>Notification prettify</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="resources/images/gallery/12.jpg" alt="12"/>
    ...
    <script src="resources/plugins/jquery-cookies/jquery.cookies.min.js"></script> <!-- Jquery Cookies, for theme -->
    <script src="resources/plugins/jquery-block-ui/jquery.blockUI.min.js"></script> <!-- simulate synchronous behavior when using AJAX -->
    <script src="resources/plugins/translate/jqueryTranslator.min.js"></script> <!-- Translate Plugin with JSON data -->
    <script src="resources/plugins/bootbox/bootbox.min.js"></script> <!-- Modal with Validation -->
    <script src="resources/plugins/mcustom-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script> <!-- Custom Scrollbar sidebar -->
    <script src="resources/plugins/bootstrap-dropdown/bootstrap-hover-dropdown.min.js"></script> <!-- Show Dropdown on Mouseover -->
    <script src="resources/plugins/charts-sparkline/sparkline.min.js"></script> <!-- Charts Sparkline -->
    <script src="resources/plugins/retina/retina.min.js"></script> <!-- Retina Display -->
    <script src="resources/plugins/select2/select2.min.js"></script> <!-- Select Inputs -->
    <script src="resources/plugins/icheck/icheck.min.js"></script> <!-- Checkbox & Radio Inputs -->
    <script src="resources/plugins/backstretch/backstretch.min.js"></script> <!-- Background Image -->
    <script src="resources/plugins/bootstrap-progressbar/bootstrap-progressbar.min.js"></script> <!-- Animated Progress Bar -->
    <script src="resources/js/builder.js"></script> <!-- Theme Builder -->
    <script src="resources/js/sidebar_hover.js"></script> <!-- Sidebar on Hover -->
    ...
    <script src="resources/js/widgets/notes.js"></script> <!-- Notes Widget -->
    <script src="resources/js/quickview.js"></script> <!-- Chat Script -->
    <script src="resources/js/pages/search.js"></script> <!-- Search Script -->
    <!-- BEGIN PAGE SCRIPT -->
    <script src="resources/plugins/noty/jquery.noty.packaged.min.js"></script>  <!-- Notifications -->
    <script src="resources/plugins/bootstrap-editable/js/bootstrap-editable.min.js"></script> <!-- Inline Edition X-editable -->
    <script src="resources/plugins/bootstrap-context-menu/bootstrap-contextmenu.min.js"></script> <!-- Context Menu -->
    <script src="resources/plugins/multidatepicker/multidatespicker.min.js"></script> <!-- Multi dates Picker -->
    <script src="resources/js/widgets/todo_list.js"></script>
    <script src="resources/plugins/metrojs/metrojs.min.js"></script> <!-- Flipping Panel -->
    <script src="resources/plugins/charts-chartjs/Chart.min.js"></script>  <!-- ChartJS Chart -->
    <script src="resources/plugins/charts-highstock/js/highstock.min.js"></script> <!-- financial Charts -->
    <script src="resources/plugins/charts-highstock/js/modules/exporting.min.js"></script> <!-- Financial Charts Export Tool -->
    <script src="resources/plugins/maps-amcharts/ammap/ammap.min.js"></script> <!-- Vector Map -->
    <script src="resources/plugins/maps-amcharts/ammap/maps/js/worldLow.min.js"></script> <!-- Vector World Map  -->
    <script src="resources/plugins/maps-amcharts/ammap/themes/black.min.js"></script> <!-- Vector Map Black Theme -->
    <script src="resources/plugins/skycons/skycons.min.js"></script> <!-- Animated Weather Icons -->
