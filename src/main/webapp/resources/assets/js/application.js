...
function switchLanguage() {
    ...
    $('#language-header').on('click', 'ul a', function(e) {
        ...
        if($('body').hasClass('builder-admin') || $('.page-content').hasClass('page-builder') || $('.page-content').hasClass('email-builder') || $('.page-content').hasClass('frontend-builder')) {
            $("[data-translate]").jqTranslate('../../admin/resources/plugins/translate/application', {
                forceLang: language
            });
        }
        else{
            $("[data-translate]").jqTranslate('resources/plugins/translate/application', {
                forceLang: language
            });
        }
...
function handleboxedLayout() {
    ...
    if ($('body').hasClass('boxed')) {
        ...
        $.backstretch(["resources/images/gallery/bg1.jpg", "resources/images/gallery/bg2.jpg", "resources/images/gallery/bg3.jpg", "resources/images/gallery/bg4.jpg"], {
            fade: 3000,
            duration: 4000
        });
    }
