        ...
        setTimeout(function () {
            $('select').each(function(){
                function format(state) {
                    ...
                    if(res[0] == 'image') {
                        if(res[2]) return "<img class='flag' src='resources/images/flags/" + res[1].toLowerCase() + "-" + res[2].toLowerCase() +".png' style='width:27px;padding-right:10px;margin-top: -3px;'/>" + state.text;
                        else return "<img class='flag' src='resources/images/flags/" + res[1].toLowerCase() + ".png' style='width:27px;padding-right:10px;margin-top: -3px;'/>" + state.text;
                    }
                    else {
                        return state.text; 
                    }
    ...
    if ($('.table-dynamic').length && $.fn.dataTable) {
        $('.table-dynamic').each(function () {
            ...
            if ($(this).hasClass('table-tools')) {
                ...
                opt.oTableTools = {
                    "sSwfPath": "resources/plugins/datatables/swf/copy_csv_xls_pdf.swf",
