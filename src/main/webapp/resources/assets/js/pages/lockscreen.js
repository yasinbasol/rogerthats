$(function() {
    $.backstretch(["resources/images/gallery/login4.jpg", "resources/images/gallery/login3.jpg", "resources/images/gallery/login2.jpg", "resources/images/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    /* Background Slide */
    $('.bg-slider').backstretch(["resources/images/gallery/login4.jpg", "resources/images/gallery/login3.jpg", "resources/images/gallery/login2.jpg", "resources/images/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    $('#image-cb').change(function() {
        if ($(this).is(":checked")) {
            $.backstretch(["resources/images/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
            });
