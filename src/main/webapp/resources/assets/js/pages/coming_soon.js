...
$(document).ready(function() {
    if ($('#map').length) {
        ...
        /* Background Slide */
        $.backstretch([ "resources/images/gallery/login4.jpg", "resources/images/gallery/login3.jpg", "resources/images/gallery/login2.jpg", "resources/images/gallery/login.jpg"],{fade: 600, duration: 4000 
        });
    }
    map_height();
